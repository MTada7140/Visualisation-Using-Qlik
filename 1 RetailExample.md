...
### In this section, I'd like to explain a little bit about load script of Qlik. With load script of Qlik, you can extract data from wide variety of sources including RDBMS(including data warehouse), CSV/text file, Excel Spreadsheet, business systems(SAP, SFDC) etc. 
